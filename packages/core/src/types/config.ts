...
export type IDKitConfig = {
	...
	partner?: boolean
	/**
	 * When true, the authenticator requires Face Authentication before generating a proof for this request.
	 * If Face Authentication fails or is not performed, no proof will be generated by the authenticator.
	 */
	face_auth?: boolean
}
